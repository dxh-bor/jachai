            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                <div className="flex items-center">
                    <input
                        ...
                        className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-slate-300 rounded transition-all cursor-pointer"
                    />
                ...
                >
                    {processing ? <Loader2 className="animate-spin mr-2" size={20} /> : 'Sign In'}
                </button>
